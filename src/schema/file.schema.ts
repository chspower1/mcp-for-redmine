...
export const RedmineFileSchema = z.object({
  ...
  version: RedmineReferenceSchema.optional().describe("Optional version this file is associated with"),
});
...
export const ListFilesToolSchema = z.object({
  project_id: z.union([z.string(), z.number()]).describe("The numeric ID or string identifier of the project to list files for"),
